<template>
  <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      ...
      >
        <tr>
          <th scope="col" class="px-6 py-3">App Action</th>
          <th scope="col" class="px-6 py-3">Action Info</th>
          <th scope="col" class="px-6 py-3">Action Timestamp</th>
        </tr>
      </thead>
      <tbody>
        <tr
        ...
        >
          ...
          <td class="px-6 py-4">Report Info added for InvoiceNo:</td>
