  ...
  <nav class="bg-white border-gray-200 dark:bg-gray-900">
    ...
    >
      <NuxtLink href="/" class="flex items-center">
        <span
          class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white text-primary-600"
          >Reporting Services</span
        >
      </NuxtLink>
      <button
        ...
        >
          <li>
            <NuxtLink
              ...
              class="block py-2 pl-3 pr-4 text-primary-400 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-primary-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
              >Home</NuxtLink
            >
          </li>
          <!-- <li>
